export default {
  ...
  home: {
    go: "GO",
    onlineNotice: "If you are on service, call your manager to put you online!",
    stop: "STOP",
  ...
  ride: {
    ...
    rideCanceledTitle: "Ride Canceled",
    endRide: "End Ride",
    arrived: "I arrived",
    clientOnHisWay:
    ...
    fare: "Fare",
    distance: "Distance",
    enRoute: "On the way to client",
    ongoingRide: "Ride in progress",
    tripCompleted: "Ride completed!",
    rateClient: "How was the client?",
  ...
  form: {
    ...
    loginSubtitle: "Sign in to start driving",
    registerHeader: "Create your account",
    registerSubtitle: "Start earning with Mamdoo",
  ...
  account: {
    ...
    switchToClient: "Switch to passenger mode",
