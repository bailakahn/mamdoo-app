...
export default function PinVerification({ navigation }) {
  ...
  const canSubmit =
    partner.forgotPinUser.code?.length === 4 &&
    partner.forgotPinUser.pin?.length === 4 &&
    partner.forgotPinUser.pinValidation?.length === 4;
      ...
      >
        ...
        >
          ...
          <OtpInput
            ...
            onChange={(code) => {
              partner.actions.setForgotPinUser({ ...partner.forgotPinUser, code });
          ...
          >
            <RNTextInput
              ...
              onChangeText={(pin) => {
                partner.actions.setForgotPinUser({ ...partner.forgotPinUser, pin });
          ...
          >
            <RNTextInput
              ...
              onChangeText={(pinValidation) => {
                partner.actions.setForgotPinUser({ ...partner.forgotPinUser, pinValidation });
        ...
        <View style={[styles.footer, { paddingBottom: keyboardVisible ? 20 : Math.max(insets.bottom + 16, 24) }]}>
          <Button
            mode="contained"
            onPress={() => partner.actions.resetPin()}
            disabled={!canSubmit}
            style={styles.btn}
