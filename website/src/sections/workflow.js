...
export default function WorkFlow() {
  ...
  const data = useMemo(
    () => [
      {
        id: 1,
        title: t("Home.other_services_1"),
        text: t("Home.other_services_1_description"),
      },
      {
        id: 2,
        title: t("Home.other_services_2"),
        text: t("Home.other_services_2_description"),
      },
      {
        id: 3,
        title: t("Home.other_services_3"),
        text: t("Home.other_services_3_description"),
      },
    ],
    []
  );
  ...
  return (
    <section sx={{ variant: "section.workflow" }}>
      <Container>
        <SectionHeader
          title={t("Home.other_services")}
          description={t("Home.other_services_description")}
        />
