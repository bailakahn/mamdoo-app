export default {
  ...
  upload: {
    ...
    cabLicenseTake: "Prendre une photo",
    back: "Précédent",
  ...
  form: {
    ...
    login: "Se connecter",
    register: "S'inscrire",
    loginHeader: "Bon retour",
    loginSubtitle: "Connectez-vous pour conduire",
    registerHeader: "Créer votre compte",
    registerSubtitle: "Commencez à gagner avec Mamdoo",
