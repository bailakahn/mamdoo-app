export default {
  main: {
    iAmAClient: "I am a passenger",
    clientSubtitle: "Book a ride in seconds",
    partnerSubtitle: "Start your driving activity",
    howDoYouWantToTravel: "How do you want to travel?",
    bookABike: "Book a bike",
    start: "Start",
    iam: "I am a",
    iAmAPartner: "I am a driver",
  ...
  form: {
    ...
    registerSubtitle: "Let's get you moving",
    alreadyHaveAccount: "Already have an account?",
    notRegisteredYet: "New to Mamdoo?",
    forgotPassword: "Forgot your PIN?",
    pinChoose: "Choose a 4-digit PIN",
    pinPlaceholder: "Something you will remember",
    registerPin: "Pin Code (4 digits)",
    pinResetTitle: "Create new PIN",
    pinResetDescription:
      "Choose a new PIN. Do not use the same code as the one we sent by SMS.",
    switchToDriver: "Switch to driver app",
  ...
  ridesHistory: {
    ...
    status: "Status",
    noRides: "No Ride",
    cabType: "Vehicle Type",
    completed: "Completed",
    canceled: "Canceled",
    noCompletedRides: "No completed rides",
    noCanceledRides: "No canceled rides",
