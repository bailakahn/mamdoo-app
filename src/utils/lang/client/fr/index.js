export default {
  ...
  ride: {
    ...
    tryLater: "Veuillez réessayer dans quelques minutes!",
    tryAgain: "Veuillez réessayer encore!",
    noMamdoo: "Tous les Mamdoo sont occupés avec d'autres courses",
  ...
  form: {
    ...
    registerSubtitle: "Prêt à voyager ?",
    alreadyHaveAccount: "Vous avez déjà un compte ?",
    notRegisteredYet: "Nouveau sur Mamdoo ?",
    forgotPassword: "Code PIN oublié ?",
    pinChoose: "Choisissez un PIN à 4 chiffres",
    pinPlaceholder: "Un code facile á retenir",
    registerPin: "Code Pin (4 chiffres)",
    pinResetTitle: "Nouveau code PIN",
    pinResetDescription:
      "Choisissez un nouveau PIN. N'utilisez pas le même code que celui envoyé par SMS.",
    switchToDriver: "Passer à l'application chauffeur",
